...
provides(BuildProcess,
	(@build_steps begin
		...
		@build_steps cp(joinpath(extractdir(32),"libnlopt-0.dll"), destw(32), remove_destination=true)
		@build_steps cp(joinpath(extractdir(64),"libnlopt-0.dll"), destw(64), remove_destination=true)
